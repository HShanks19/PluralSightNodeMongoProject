...
function circulationRepo(){
    ...
    function getById(id){
        return new Promise(async(resolve, reject) => {
            ...
            try {
                await client.connect();
                const db = client.db(dbName);
                //returns single object not cursor
        ...
        return new Promise(async(resolve, reject) => {
            ...
            try {
                ...
                const updatedItem = await db.collection('newspapers')
                    .findOneAndReplace({_id: id}, newItem, { returnNewDocument:true });
        ...
        return new Promise(async(resolve, reject) => {
            ...
            try {
                ...
                const average = await db.collection('newspapers')
                    .aggregate([{ $group: {_id:null, avgFinalists: { $avg: "$Pulitzer Prize Winners and Finalists, 1990-2014"}}}]).toArray();
    ...
    return { loadData, get, getById, add, update, removed, averageFinalists, averageFinalistsByChange }
}
